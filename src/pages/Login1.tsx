    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-900 p-4">
      <div className="grid md:grid-cols-2 overflow-hidden rounded-2xl shadow-lg max-w-4xl w-full">
        <div className="p-10 flex flex-col justify-center bg-gradient-to-br from-blue-600 to-indigo-800 hidden md:flex">
          ...
          <h1 className="text-4xl font-bold text-white mb-6">Hotel Management System</h1>
          <p className="text-blue-100 mb-8">
            Access your dashboard to manage rooms, guests, and reservations seamlessly.
          </p>
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <span className="text-white">Real-time room status tracking</span>
            </div>
            <div className="flex items-center">
              <div className="w-10 h-10 rounded-full bg-blue-500 bg-opacity-30 flex items-center justify-center mr-4">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-white">Efficient guest management</span>
            </div>
            <div className="flex items-center">
              <div className="w-10 h-10 rounded-full bg-blue-500 bg-opacity-30 flex items-center justify-center mr-4">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-white">Comprehensive booking system</span>
            </div>
          </div>
        </div>
